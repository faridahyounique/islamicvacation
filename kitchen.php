...
if (isset($_SESSION['id']) && isset($_SESSION['username'])) {
    ...
    $print_main ='';
    $i =0;
    $sql="SELECT * FROM `islamicvacationcourse_tbl` WHERE volunteer ='yes' AND volunteer2  ='Kitchen'";
    $counter='';
...
<html>
  <head>
  <title>LIST OF PREVIOUS KITCHEN VOLUNTEERS</title>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.min.js"></script>
   ...
   <div class="container">
        <div class="nav justify-content-center  rounded">
              <h1 class="text-success">LIST OF PREVIOUS KITCHEN VOLUNTEERS</h1>
        </div>
        <div class="row">
