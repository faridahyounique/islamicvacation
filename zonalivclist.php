...
if (isset($_SESSION['id']) && isset($_SESSION['username'])) {
    ...
    $print_main ='';
    $i =0;
    $sql="SELECT * FROM `islamicvacationcourse_tbl` WHERE `type`= 'zonal'";
    $counter='';
    ...
    $print_main .= '
    <h3 text-center>LIST OF ZONAL IVC APPLICANTS</h3>
                    <table>
                        <thead>
                            <tr>
                                <th> S/N</th>
...
<html>
  <head>
  <title>LIST OF ZONAL IVC APPLICANTS</title>
...
<link rel="stylesheet" href="../../maxcdn.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css">
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.min.js"></script>
   ...
   <div class="nav justify-content-center  rounded">
              <h4 class="text-success">LIST OF ZONAL IVC APPLICANTS</h4>
        </div>
        <center>
            <br><form action="" method="POST">
                    <div class="row">
                        ...
                        <div class="col-sm-2 font-weight-bolder">Select State</div>
                            <div class="col-sm-3">
                                <Select class="form-control font-weight-bold" id="zonal" name="state_location" required>
        ...
        ?>
        <div class="row">
                <center><h5 class="text-success">List of Zonal Applicants From All Camps</h5></center>
       ...
       ?>
                <div class="row">
               <center><h5 class="text-success">List of Zonal Applicants From <?=$state?> Camp</h5></center> 
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr>
           <th> S/N</th>
        ...
        <tr class="table table-bordered table-hover table-info">
            <?php
                //include 'connect_database.php';
                $i =0;
                $sql="SELECT * FROM `islamicvacationcourse_tbl` WHERE `type`= 'zonal' AND zone='$state'";
                $counter='';
                if ($result = $conn->query($sql)) {
                    $counter=$counter++;     
