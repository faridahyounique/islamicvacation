...
if (isset($_SESSION['id']) && isset($_SESSION['username'])) {
    ...
    $print_main ='';
    $i =0;
    $sql="SELECT * FROM `islamicvacationcourse_tbl` WHERE volunteer3 ='yes' AND volunteer4  ='Kitchen'";
    $counter='';
...
<html>
  <head>
  <title>LIST OF KITCHEN VOLUNTEERS</title>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.min.js"></script>
   ...
   <div class="container">
        <div class="nav justify-content-center  rounded">
              <h1 class="text-success">LIST OF KITCHEN VOLUNTEERS</h1>
        </div>
        <div class="row">
    ...
    <tr class="table table-bordered table-hover table-info">
        <?php
            include 'connect_database.php';
            $i =0;
            $sql="SELECT * FROM `islamicvacationcourse_tbl` WHERE volunteer3 ='yes' AND volunteer3  ='Kitchen'";
            $counter='';
            if ($result = $conn->query($sql)) {
                $counter=$counter++;     
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td class="profile"><?php echo $row['aspect2']; ?></td>
                        <?php
                }
            }
            else{
