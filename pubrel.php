...
if (isset($_SESSION['id']) && isset($_SESSION['username'])) {
    ...
    $print_main ='';
    $i =0;
    $sql="SELECT * FROM `islamicvacationcourse_tbl` WHERE volunteer ='yes' AND volunteer2  ='Public relations'";
    $counter='';
...
<html>
  <head>
  <title>LIST OF PREVIOUS PUBLIC RELATIONS VOLUNTEERS</title>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.min.js"></script>
   ...
   <div class="container">
        <div class="nav justify-content-center  rounded">
              <h1 class="text-success">LIST OF PREVIOUS PUBLIC RELATIONS VOLUNTEERS</h1>
        </div>
        <div class="row">
            ...
            if ($result = $conn->query($sql)) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td class="profile"><?php echo $row['aspect']; ?></td>
                        <?php
                }
            }
            else{
