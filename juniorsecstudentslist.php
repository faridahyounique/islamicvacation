...
if (isset($_SESSION['id']) && isset($_SESSION['username'])) {
    ...
    $print_main ='';
    $i =0;
    $sql="SELECT * FROM `islamicvacationcourse_tbl` WHERE `category`= 'Junior Secondary School'";
    $counter='';
    ...
    $print_main .= '
    <h3 text-center>LIST OF HIGHER INSTITUTION STUDENTS</h3>
                    <table>
                        <thead>
                            <tr>
                                <th> S/N</th>
...
<html>
  <head>
  <title>LIST OF HIGHER INSTITUTION STUDENTS</title>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.min.js"></script>
   ...
   <div class="container">
        <div class="nav justify-content-center  rounded">
              <h1 class="text-success">LIST OF HIGHER INSTITUTION STUDENTS</h1>
        </div>
        <div class="row">
            ...
            if ($result = $conn->query($sql)) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td class="profile"><?php echo $row['institution']; ?></td>
                                               <?php
                }
            }
            else{
