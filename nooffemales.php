...
if (isset($_SESSION['id']) && isset($_SESSION['username'])) {
    ...
    $print_main ='';
    $i =0;
    $sql="SELECT * FROM `islamicvacationcourse_tbl` WHERE `gender`= 'female'";
    $counter='';
    ...
    $print_main .= '
    <h3 text-center>LIST OF FEMALES</h3>
                    <table>
                        <thead>
                            <tr>
                                <th> S/N</th>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.min.js"></script>
   ...
   <div class="container">
        <div class="nav justify-content-center  rounded">
              <h1 class="text-success">LIST OF FEMALES</h1>
        </div>
        <div class="row">
            ...
            if ($result = $conn->query($sql)) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td class="profile"><?php echo $row['title']. ' '.$row['Surname']. ' '.$row['firstname']. ' '.$row['middlename']; ?></td>
                        <?php
                }
            }
            else{
