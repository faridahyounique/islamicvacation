...
if (isset($_SESSION['id']) && isset($_SESSION['username'])) {
    ...
    $print_main ='';
    $i =0;
    $sql="SELECT * FROM `islamicvacationcourse_tbl` WHERE volunteer3 ='yes' AND volunteer4  ='Medical Assistant'";
    $counter='';
...
<html>
  <head>
  <title>LIST OF MEDICAL ASSISTANT VOLUNTEERS</title>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.min.js"></script>
   ...
   <div class="container">
        <div class="nav justify-content-center  rounded">
              <h1 class="text-success">LIST OF MEDICAL ASSISTANT VOLUNTEERS</h1>
        </div>
        <div class="row">
